...
var autoScroll = setInterval(function () {
  promotarget.scrollBy(200, 0);
}, 30000);

//Chevrons
const nudgedown = document.querySelector(".chevrons");
const herodisable = document.querySelector(".hero-container");

var h = window.innerHeight - 400;
nudgedown.addEventListener("click", () => {
  //window.scrollBy(0, h);
  nudgedown.classList.toggle("flip");
  herodisable.classList.toggle("disabled");
});
